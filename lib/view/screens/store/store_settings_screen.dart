          ...
          return Column(children: [
            Expanded(
              ...
              child: Column(children: [
                ...
                (_module!.vegNonVeg! && Get.find<SplashController>().configModel!.toggleVegNonVeg!)
                    ? Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          'item_type'.tr,
            ...
            !storeController.isLoading
                ? CustomButton(
                    ...
                    onPressed: () {
                      ...
                      if (defaultNameNull) {
                      ...
                      } else if ((_module!.vegNonVeg! && Get.find<SplashController>().configModel!.toggleVegNonVeg!) && !storeController.isStoreVeg! && !storeController.isStoreNonVeg!) {
                        ...
                        storeController.updateStore(
                          ...
                          minimum,
                          maximum,
                          storeController.durations[storeController.durationIndex - 1],
                          translation,
                        );
                      }
                    },
